...
const examples: InternalExampleDefinition[] = [
  {
    ...
    options: {format: 'electrongeneric', name: 'RL', load: '0x0e00', entry: '0x801f', shortpilot: true},
  ...
  },
  {
    ...
    options: {format: 'electrongeneric', name: 'RL', load: '0x1000', entry: '0x1000', shortpilot: true},
  ...
  {
    machine: 'Apple II',
    adapter: 'apple2generic',
    path: 'apple2/rl.bin',
    options: {format: 'apple2generic', shortpilot: true},
    hash: '0410b697e76a95bb5de1002bb04704a0',
    instructions: '800.898R\n800G',
    tests: ['2025-10-25 (MAME Emulator - Apple II)'],
  },
  {
    machine: 'Apple II',
    adapter: 'apple2generic',
    path: 'apple2/rl.bas',
    options: {format: 'apple2generic', shortpilot: true, apple2integerbasic: true},
    hash: 'b15afaf8972236539a7c554be9a4873d',
    instructions: 'LOAD\nRUN',
    tests: ['2025-10-25 (MAME Emulator - Apple II)'],
  },
  {
  ...
  },
  {
    ...
    adapter: 'c64generic',
    path: 'c64/rl.bin',
    options: {format: 'c64generic', c64type: 'prg', load: '4352', shortpilot: true, name: 'RL'},
  ...
  },
  {
    ...
    adapter: 'c64generic',
    path: 'c64/rl.bin',
    options: {format: 'c64generic', c64type: 'prg', load: '4352', c64machine: 'vic20pal', name: 'RL', shortpilot: true},
  ...
  },
  {
    ...
    adapter: 'cpcgeneric',
    path: 'cpc/rl.bin',
    options: {format: 'cpcgeneric', load: '0x2000', entry: '0x2000', name: 'RL'},
  ...
  },
  {
    ...
    adapter: 'ibm5150basic',
    path: 'ibm5150/rl.b',
    options: {format: 'ibm5150basic', name: 'rl', ibm5150basictype: '128'},
    hash: '32a0c1d4746d48d350f13d2f91e2a7dc',
    instructions: 'load "rl"\nrun',
  ...
  },
  {
    ...
    adapter: 'kcgeneric',
    path: 'kc851/rl.com',
    options: {format: 'kcgeneric', name: 'RL', load: '0x0300', entry: '0x0300', firstblock: '0'},
    hash: '117e0758f5effea2aaff8a234797ea19',
    instructions: 'RL\n<return>',
  ...
  },
  {
    ...
    adapter: 'lc80generic',
    path: 'lc80/rl.bin',
    options: {name: '0xffff', load: '0x2000', format: 'lc80generic'},
  ...
  },
  {
    ...
    adapter: 'mpfgeneric',
    path: 'mpf/rl.bin',
    options: {name: '0xffff', load: '0x1800', format: 'mpfgeneric', shortpilot: true},
  ...
  },
  {
    ...
    adapter: 'msxgeneric',
    path: 'msx/rl.bin',
    options: {format: 'msxgeneric', shortpilot: true, msxfast: true, name: 'RL', load: '0x8000', entry: '0x8000', msxtype: 'binary'},
    hash: 'abcc9aef0dbe1802df60c6bb05d2d09c',
    instructions: 'bload"cas:",r',
    tests: ['2023-12-10 OK (Philips VG-8020)'],
  },
  {
    ...
    adapter: 'oricgeneric',
    path: 'oric/rl.bin',
    options: {format: 'oricgeneric', shortpilot: true, name: 'RL', load: '0x1000', 'oricautostart': true},
  ...
  },
  {
    ...
    path: 'sharpmz/rl.bin',
    options: {format: 'sharpmzgeneric', shortpilot: true, name: 'RL', load: '0x1200', entry: '0x1200', sharpmznorepeat: true, sharpmztype: '1'},
  ...
  },
  {
    ...
    options: {format: 'zxspectrumgeneric', name: 'RL', load: '32768', zxtype: '3'},
