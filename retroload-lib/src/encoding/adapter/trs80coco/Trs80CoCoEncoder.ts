...
export const BLOCK_TYPE_NAMEFILE = 0x00;
export const BLOCK_TYPE_DATA = 0x01;
export const BLOCK_TYPE_END_OF_FILE = 0xff;
...
export class Trs80CoCoEncoder implements ByteRecorder {
  ...
  public recordRawBytes(data: BufferAccess): void {
